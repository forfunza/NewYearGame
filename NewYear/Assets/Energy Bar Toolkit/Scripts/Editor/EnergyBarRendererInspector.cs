...
#if MAD_DEBUG
            PropertyFieldToggleGroup2(effectEdge, "Edge Effect", () => {
                Indent(() => {
                    PropertyField(effectEdgeTexture, "Edge Texture");
                    PropertyField(effectEdgeIn, "Fade In Buffer");
                    PropertyField(effectEdgeOut, "Fade Out Buffer");
                    PropertyField(effectEdgeRotateAngle, "Rotation");
                });
            });
#endif
